  ...
  return (
    <div className="modeler-wrapper">
      <div className="button-container">
        <button className="modeler-btn" onClick={handleNew} title="New BPMN Diagram">
          New
        </button>
        <button className="modeler-btn" onClick={handleSave} title="Export BPMN XML">
          Export
        </button>
        <button className="modeler-btn" onClick={handleExportSVG} title="Export SVG">
          Export SVG
        </button>
